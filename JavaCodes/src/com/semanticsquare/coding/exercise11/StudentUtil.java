...
public class StudentUtil {
    ...
    public static double[] calculateGPA(int[] studentIdList, char[][] studentsGrades)
            throws IllegalArgumentException, MissingGradeException {
        ...
        if(studentIdList.length != studentsGrades.length) {
            throw new IllegalArgumentException(studentIdList.length, studentsGrades.length);
        }
    ...
    public static int[] getStudentsByGPA(double lower, double higher, int[] studentIdList, char[][] studentsGrades) throws IllegalArgumentException, MissingGradeException, InvalidDataException {
        ...
        try {
            ...
            e.initCause(new InvalidDataException("This is the MissingGradeException: "));
            throw e;
        }
