...
package com.semanticsquare.coding.exercise2;
...
//        double salesPrice = carPriceEstimator.getSalePrice("ford ecosport", 2018, 60000.0, 2, true, false, true, false, false, true);
        //double salesPrice = carPriceEstimator.getSalePrice("ford ecosport", 2023, 60000.0, 1, true, true, true, false, false, true);
        carPriceEstimator.getSalePrice("ford ecosport", 2023, 5000.0, 2, true, true, true, false, false, false);
    }
}
